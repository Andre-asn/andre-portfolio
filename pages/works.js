  ...
  <div class="overflow-hidden flex flex-col md:flex-row gap-4 items-center">
    <div class="backdrop-blur-[1rem] bg-white/30 p-6 rounded-md shadow-md flex flex-col items-center max-w-[400px]">
      ...
      <form action="" target="_blank">
        <button disabled type="submit" className="shadow-lg ring-white ring-1 hover:bg-red-600 transition ease-in-out text-white text-lg font-bold mt-6 px-6 py-3 rounded">
          Under Construction
        </button>
      </form>
    </div>
