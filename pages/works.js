            ...
            <FadeInOnScroll>
                ...
                <div class="overflow-hidden flex flex-col md:flex-row gap-4 items-center">
                    <div class="backdrop-blur-[1rem] bg-white/30 p-6 rounded-md shadow-md flex flex-col items-center max-w-[400px]">
                        <h2 class="shadow-xl py-4 text-2xl text-white bg-[#14213D] w-full text-center mb-4">Anime Axis</h2>
                    ...
                    <div class="backdrop-blur-[1rem] bg-white/30 p-6 rounded-md shadow-md flex flex-col items-center max-w-[400px]">
                        <h2 class="shadow-xl py-4 text-2xl text-white bg-[#14213D] w-full text-center mb-4">Stroopy</h2>
                        <p class="text-xl break-words text-[#E5E5E5] text-center">
                    ...
                    <div class="backdrop-blur-[1rem] bg-white/30 p-6 rounded-md shadow-md flex flex-col items-center max-w-[400px]">
                        <h2 class="shadow-xl py-4 text-2xl text-white bg-[#14213D] w-full text-center mb-4">Portion</h2>
                        <p class="text-xl break-words text-[#E5E5E5] text-center">
