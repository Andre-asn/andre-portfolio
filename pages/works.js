...
const Works = () => {
    return (
        <div id="works" className="overflow-hidden min-h-screen flex flex-col justify-center align-middle items-center">
            <FadeInOnScroll>
                <h1 className="mt-32 text-6xl pb-10 font-outfit font-normal text-white text-center text-shadow-lg">Some of my <span className="text-[#FCA311] font-semibold">work</span></h1>
                <div className="overflow-hidden flex flex-col md:flex-row gap-4 items-stretch">
                    <div className="backdrop-blur-[1rem] bg-white/30 p-6 rounded-md shadow-md flex flex-col items-center max-w-[400px] h-[500px]">
                        <h2 className="shadow-xl py-4 text-2xl text-white bg-[#14213D] w-full text-center mb-4 text-shadow">Anime Axis</h2>
                        <p className="text-xl break-words text-[#E5E5E5] text-center flex-grow text-shadow-sm">
                        ...
                        <form action="https://github.com/Andre-asn/ecommerce-proj" target="_blank" className="mt-auto pt-4">
                            <button type="submit" className="shadow-lg ring-white ring-1 hover:bg-[#FCA311] transition ease-in-out text-white text-lg font-bold px-6 py-3 rounded text-shadow">
                                View
                            </button>
                        </form>
                    </div>
                    <div className="backdrop-blur-[1rem] bg-white/30 p-6 rounded-md shadow-md flex flex-col items-center max-w-[400px] h-[500px]">
                        ...
                        <form action="https://github.com/danzam284/NutritionAI" target="_blank" className="mt-auto pt-4">
                            <button type="submit" className="shadow-lg ring-white ring-1 hover:bg-[#FCA311] transition ease-in-out text-white text-lg font-bold px-6 py-3 rounded text-shadow">
                                View
                            </button>
                        </form>
                    ...
                    <div className="backdrop-blur-[1rem] bg-white/30 p-6 rounded-md shadow-md flex flex-col items-center max-w-[400px] h-[500px]">
                        ...
                        <form action="https://stroopy.vercel.app" target="_blank" className="mt-auto pt-4">
                            <button type="submit" className="shadow-lg ring-white ring-1 hover:bg-[#FCA311] transition ease-in-out text-white text-lg font-bold px-6 py-3 rounded text-shadow">
                                View
                            </button>
                        </form>
                    ...
                    <div className="backdrop-blur-[1rem] bg-white/30 p-6 rounded-md shadow-md flex flex-col items-center max-w-[400px] h-[500px]">
                        ...
                        <form action="" target="_blank" className="mt-auto pt-4">
                            <button type="submit" className="disabled shadow-lg ring-white ring-1 hover:bg-[#d62828] transition ease-in-out text-white text-lg font-bold px-6 py-3 rounded text-shadow">
                                Under Dev
                            </button>
                        </form>
                    </div>
