    ...
    return (
        <div id="works" className="overflow-hidden min-h-screen flex flex-col justify-center align-middle items-center px-4 py-16">
            ...
            <div className="overflow-x-auto w-full">
                <div className="flex flex-col md:flex-row gap-4 items-stretch min-w-max px-4 justify-center">
                    <div className="bg-white/30 p-6 rounded-md shadow-md flex flex-col w-[300px] md:w-[400px] h-[500px]">
